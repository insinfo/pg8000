...
// dart test test/integration/query_test.dart --plain-name "queryUnnamed at Sign @ placeholder" --chain-stack-traces -j 1
void main() {
  late CoreConnection con;

  setUp(() async {
    con = CoreConnection(
      Platform.environment['PGUSER'] ?? 'dart',
      ...
      password: Platform.environment['PGPASSWORD'] ?? 'dart',
      textCharset: 'utf8',
    );
    await con.connect();
